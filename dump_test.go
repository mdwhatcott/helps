...
func TestFormatXML_ByteOrderMarkIgnored(t *testing.T) {
	...
	output := FormatXML(append(utf8ByteOrderMark, input...))

	assertions.New(t).So(output, should.Equal, `<?xml version="1.0" encoding="utf-8"?><candidates>
  <candidate>
